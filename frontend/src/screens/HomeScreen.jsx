...
import köri from "../assets/köri.jpg";
        ...
        <>
            ...
            <section className="uk-section uk-padding-remove-top">
                ...
                <div className="uk-section uk-padding-remove-bottom">
                    <div className="uk-container">
                        <div className="uk-grid-medium uk-margin-auto uk-child-width-1-3@m uk-child-width-1-2@s uk-flex-center" data-uk-grid>
                            <div>
                                <div className="uk-card uk-card-default">
                                    <div className="uk-card-media-top cs-height">
                                        <img src={icli_kofte} alt="icli_kofte" data-uk-img className="uk-width-1-1 uk-height-1-1"/>
                                    </div>
                                    <div className="uk-card-body cs-height-body">
                                        <h3 className="uk-card-title">İçli Köfte</h3>
                                        <div className="line"/>
                            ...
                            <div>
                                <div className="uk-card uk-card-default">
                                    ...
                                    <div className="uk-card-body cs-height-body">
                                        <h3 className="uk-card-title">Mantı</h3>
                                        <div className="line"/>
                            ...
                            <div>
                                <div className="uk-card uk-card-default">
                                    ...
                                    <div className="uk-card-body cs-height-body">
                                        <h3 className="uk-card-title">Boşnak Böreği</h3>
                                        <div className="line"/>
                            ...
                            <div>
                                <div className="uk-card uk-card-default">
                                    ...
                                    <div className="uk-card-body cs-height-body">
                                        <h3 className="uk-card-title">Zeytinyağlı Sarma</h3>
                                        <div className="line"/>
                            ...
                            <div>
                                <div className="uk-card uk-card-default">
                                    ...
                                    <div className="uk-card-body cs-height-body">
                                        <h3 className="uk-card-title">Muhammara</h3>
                                        <div className="line"/>
                            ...
                            <div>
                                <div className="uk-card uk-card-default">
                                    ...
                                    <div className="uk-card-body cs-height-body">
                                        <h3 className="uk-card-title">Çocuk Menüsü</h3>
                                        <div className="line"/>
                        ...
                        <div data-uk-slider>
                            <div className="uk-position-relative">
                                <div className="uk-slider-container uk-light">
                                    <ul className="uk-slider-items uk-child-width-1-1 uk-child-width-1-3@s uk-child-width-1-4@m uk-flex-center uk-grid-medium" data-uk-grid>
                                        <li className="uk-height-medium uk-width-medium">
                                        ...
                                        <li className="uk-height-medium uk-width-medium">
                                            <img src={köri} alt="köri" data-uk-img className="uk-width-1-1 uk-height-1-1"/>
                                        </li>
                                        <li className="uk-height-medium uk-width-medium">
